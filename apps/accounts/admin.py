...
# Configure admin site for accounts
...
admin.site.site_header = _('Администрирование Engler House')
admin.site.site_title = _('Engler House Админ')
admin.site.index_title = _('Панель управления Engler House')
